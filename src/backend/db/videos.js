...
export const videos = [
  {
    ...
    creatorImg: "https://yt3.ggpht.com/ytc/AKedOLQnvobEXpzHCxB1g-q2aXbRDzSaznFVHo5OdFML",
  ...
  },
  {
    ...
    description:"Learn Web 3.0 from zero. In this video, Madhavan (Founder, questbook), teaches Tanay how to write his first smart contract. ", 
    creator: "Tanay Pratap",
    timeStamp:  fromNow.from(new Date()),
  ...
  },
  {
    ...
    description:"Learn how to use Node and Express in this comprehensive course. First, you will learn the fundamentals of Node and Express. ", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(5000), 
    thumbnail: thumbnail('Oe421EPjeBE'), 
    creatorImg: "https://yt3.ggpht.com/ytc/AKedOLRyPFojwY3CXV5ks5TwPrt2VifQn-nYNfkgLvVPkw",
  ...
  },
  {
    ...
    description:"ExpressJS is the most popular Node.js web server framework and is the basis of thousands of sites. In this video I ", 
    creator: "Web Dev Simplified",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(80000), 
    thumbnail: thumbnail('SccSCuHhOw0'), 
    creatorImg: "https://yt3.ggpht.com/ytc/AKedOLQpvSjzSCSo8ZKCjBZS7TRX7omb_kyQirh2zgEY",
    categoryName: "Backend Development"
  },
  {
    ...
    description:"MongoDB is a complex NoSQL database with a ton of commands and intricacies.", 
    creator: "Web Dev Simplified",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(80000), 
  ...
  },
  {
    ...
    description:"Welcome to neogcamp's levelZero journey. You don't know anything about web development? ", 
    creator: "Tanay Pratap",
    timeStamp:  fromNow.from(new Date()),
  ...
  },
  {
    ...
    description:"This complete 134-part JavaScript tutorial for beginners will teach you everything you need to know to get started with javaScript", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(905000), 
  ...
  },
  {
    ...
    description:"This video is a full backend web development course with python.", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
  ...
  },
  {
    ...
    description:"MERN Stack Course - ALSO: Convert Backend to Serverless with MongoDB Realm", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
  ...
  },
  {
    ...
    description:"Easy JavaScript Game Development with Kaboom.js (Mario, Zelda, and Space Invaders) - Full Course", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(96000), 
...

  {
    ...
    description:"Learn Python API development in one of the most comprehensive courses ever on the topic. You will build a full-fledged API in Python using FastAPI. ", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(959000), 
  ...
  },
  {
    ...
    description:"A REST API is an integral component of a web application. You don't need to be an expert backend developer to make your own. ", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
  ...
  },
  {
    ...
    description:"This video is a complete React Crash Course for beginners. The video covers different React Topics and implementation in one single project.  ", 
    creator: "Dipesh Malvia",
    timeStamp:  fromNow.from(new Date()),
    view: kFormatter(85000), 
    thumbnail: thumbnail('0sOvCWFmrtA'), 
    creatorImg: "https://yt3.ggpht.com/ytc/AKedOLQ9EF8YtmsiSNwSKazGG2I6TZYArvYQM0_zShHvQg",
    categoryName: "Reactjs Projects", 
  },
  {
  ...
  },
  {
    ...
    description:" In this compilation of videos, you'll build a Travel Companion App, a Cryptocurrency App, a Real Estate App, a  Google Clone App, as well as create your own API! ", 
    creator: "Freecodecamp",
    timeStamp:  fromNow.from(new Date()),
  ...
  },
  {
    ...
    creatorImg: "https://yt3.ggpht.com/ytc/AKedOLSxHOOxxa9Af8Bfb2XMop3lm4tor9bViWiC-d5aaw",
    categoryName: "Reactjs Projects", 
  },
